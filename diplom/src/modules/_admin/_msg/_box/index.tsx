...
export const BoxPage: React.FC = observer(() => {
	const { openButton, isOpen, datePicker, slots, showButton, confirmButton, modal, modalAccept, modalDecline } = box;
		...
		<>
			...
			<Paper elevation={1} className={styles.main}>
				<div className={styles.content}>
					<Typography variant="h4">Бокс</Typography>
					<div className={styles.buttons}>
						<VButton model={openButton} />
						<VButton model={{onClick: () => location.replace(`./${URLS.BOX}/editor`), text: 'Редактировать'}} />
					</div>
					{
						isOpen 
						? 
