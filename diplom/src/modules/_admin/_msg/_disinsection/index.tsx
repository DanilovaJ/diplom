...
import { disinsection } from "./models";
...
export const DisinsectionPage: React.FC = observer(() => {
	const { openButton, isOpen, datePicker, slots, showButton, confirmButton, modal, modalAccept, modalDecline } = disinsection;
		...
		<>
			...
			<Paper elevation={1} className={styles.main}>
				<div className={styles.content}>
					<Typography variant="h4">Обработка комнаты от клопов</Typography>
					<div className={styles.buttons}>
						<VButton model={openButton} />
						<VButton model={{onClick: () => location.replace(`./${URLS.DISINSECTION}/editor`), text: 'Редактировать'}} />
					</div>
					{
						isOpen 
						? 
