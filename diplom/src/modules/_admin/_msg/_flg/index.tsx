...
export const FlgPage: React.FC = observer(() => {
	const { openButton, isOpen, datePicker, slots, showButton, confirmButton, modal, modalAccept, modalDecline } = flg;
		...
		<>
			...
			<Paper elevation={1} className={styles.main}>
				<div className={styles.content}>
					<Typography variant="h4">ФЛГ</Typography>
					<div className={styles.buttons}>
						<VButton model={openButton} />
						<VButton model={{onClick: () => location.replace(`./${URLS.FLG}/editor`), text: 'Редактировать'}} />
					</div>
					{
						isOpen 
						? 
