...
export const StretchingPage: React.FC = observer(() => {
	const { openButton, isOpen, datePicker, slots, showButton, confirmButton, modal, modalAccept, modalDecline } = stretching;
		...
		<>
			...
			<Paper elevation={1} className={styles.main}>
				<div className={styles.content}>
					<Typography variant="h4">Стретчинг</Typography>
					<div className={styles.buttons}>
						<VButton model={openButton} />
						<VButton model={{onClick: () => location.replace(`./${URLS.STRETCHING}/editor`), text: 'Редактировать'}} />
					</div>
					{
						isOpen 
						? 
