...
export const GymPage: React.FC = observer(() => {
	const { openButton, isOpen, datePicker, slots, showButton, confirmButton, modal, modalAccept, modalDecline } = gym;
		...
		<>
			...
			<Paper elevation={1} className={styles.main}>
				<div className={styles.content}>
					<Typography variant="h4">Тренажерный зал</Typography>
					<div className={styles.buttons}>
						<VButton model={openButton} />
						<VButton model={{onClick: () => location.replace(`./${URLS.GYM}/editor`), text: 'Редактировать'}} />
					</div>
					{
						isOpen 
						? 
